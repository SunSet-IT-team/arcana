            ...
            <div className="container">
                <div className="calculator__wrapper">
                    ...
                    <div className="calculator__content">
                        <p className="calculator__span">
                            Нажми «рассчитать» и откроется страница с твоим
                            архетипическим портретом.
                            <br />
                            <br />
                            Ты увидишь очень много римских цифр и подумаешь:
                            «Ого! А что это?»
                            <br />
                            <br />
                            Не пугайся! Каждый портрет по-своему прекрасен и
                            каждый архетип стоит на своем месте.
                            <br />
                            <br />
                            Я не обещаю тебе, что ты сразу увидишь, как решить
                            проблему или где лежат именно твои ресурсы: деньги,
                            отношения, предназначение, миссия.
                            <br />
                            <br />
                            Но кое-что про тебя станет чуточку понятнее...
                        </p>
