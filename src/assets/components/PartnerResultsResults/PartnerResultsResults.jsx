                    ...
                    <div className="partner-results__content">
                        ...
                        <div className="partner-results__text-wrapper">
                            <p className="partner-results__text">
                                ...
                                образуется общее поле. Здесь формируется
                                понимание, идем мы дальше или нет.
                            </p>
                            <p className="partner-results__text">
                                Позиция №2 – сюжет отношений. Это самая главная
                                позиция в паре. Каждый из нас проходит свои
                                уроки, но в паре мы получаем общий сюжет
                                отношений, основанный на личных уроках каждого.
                                Все сложности и пути их решения видно именно
                                здесь.
                            </p>
                            <p className="partner-results__text">
                                Позиция №3 – завершение отношений или плато.
                                Здесь сюжет или подходит к концу, или наступает
                                период спокойствия и размеренного течения жизни
                                в паре до момента нового поворотного события.
                            </p>
                            <p className="partner-results__text">
                                Если ты хочешь разобраться в отношениях с мужем,
                                женой, парнем, девушкой, другом, партнером на
