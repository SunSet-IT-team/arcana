    ...
    <section className="results">
      <div className="container">
        <div className="results__wrapper">
          <Link to="/calculator" className="results__back-link back-arrow">
            <svg
              width="21"
              height="21"
              viewBox="0 0 21 21"
          ...
          <div className="results__content">
            <div className="results__body">
              <p className="results__body-text">
                Congratulazioni! Ora sai quali Archetipi si mostrano in te.
                Queste sono le «lettere» che compongono le parole e le frasi con
                quali stai scrivendo la storia della tua vita. Cliccando su un
                numero romano che indica l’Archetipo corrispondente ad ogni
                posizione del tuo Profilo, troverai una descrizione delle
            ...
            <div className="results__info">
              <ul className="results__info-list">
                <li className="results__info-item">
                  <span className="results__info-number underline">NUMERO</span>
                ...
                {resultsData.map((result, index) => (
                  <li className="results__info-item" key={index}>
                    <span className="results__info-number">{result.num}</span>
                    <p className="results__info-name">{result.name}</p>
                    <Link
