            ...
            info: (
                <>
                    <p className="text-split">
                        ...
                        significativa con te — che si tratti di un socio in
                        affari, un dipendente, un collega, un amico, un compagno
                        di viaggio o altro — o se vuoi approfondire la
                        conoscenza di un familiare per migliorare la
                        comunicazione e costruire un rapporto più armonioso.
                    </p>
                    <h3 className="text-split">Analizzeremo: </h3>
                    <ul className="text-split">
                        <li className="text-split">
                        ...
                        <li className="text-split">
                            - obiettivi e approccio che rafforzeranno il
                            rapporto;
                        </li>
                        <li className="text-split">
                            - aspettative reciproche (anche se sono inconsce);
            ...
            info: (
                <>
                    <p className="text-split">
                        ...
                        sensazione di essere bloccato e non riesci a trovare il
                        tuo posto in questo mondo.
                    </p>
                    <p className="text-split">
                        È possibile lavorare sia con una richiesta specifica che
                        con un interesse generale per questo argomento.
                    ...
                    <ul className="text-split">
                        ...
                        <li className="text-split">
                            - potenziale da rivelare in diversi periodi della
                            vita;
                        </li>
                        <li className="text-split">- paure e complessi;</li>
                        <li className="text-split">
        ...
        },
        {
            ...
            info: (
                <>
                    <p className="text-split">
                        {' '}
                        L'individuazione di cui parlava Jung è il processo di
                        unire i pezzi del puzzle tra la tua luce e la tua ombra.
                        Questa consulenza è per te se desideri esplorare il tuo
                        subconscio, scoprire le parti represse dell'ombra della
                        tua personalità, che custodiscono un grande potenziale
                        pronto per essere compreso e integrato, per raggiungere
                        una completa integrità psicologica.
                    </p>
                    <p className="text-split">
                        È possibile lavorare sia con una richiesta specifica che
                        con un interesse generale per questo argomento.
            ...
            info: (
                <>
                    <p className="text-split">
                        ...
                        imparare come affrontare i periodi difficili delle crisi
                        di crescita nel modo più rispettoso della sua psiche,
                        riducendo al minimo l'impatto negativo delle lezioni di
                    ...
                    <ul className="text-split">
                        <li className="text-split">
                            - bambino come individuocon sue caratteristiche
                            innate;
                        </li>
                        <li className="text-split">
                            - comportamento nella norma e quando
                            necessarioprestare attenzione ai suoi bisogni;
                        </li>
                        <li className="text-split">
        ...
        },
        {
            ...
            info: (
                <>
                    <p className="text-split">
                        {' '}
                        Analisi della tua mappa archetipica in relazione a
                        quelle componenti che favoriscono la piena realizzazione
                        del tuo potenziale nel contesto professionale.
                    </p>
                    <p className="text-split">
                        È possibile lavorare sia con una richiesta specifica che
                        con un interesse generale per questo argomento.
                    ...
                    <ul className="text-split">
                        ...
                        <li className="text-split">
                            - ambiti per diventare maestro, specialista,
                            esperto;
                        </li>
                        <li className="text-split">
                    ...
                    <p className="text-split">
                        Durante la consulenza riceverai un calcolo del tuo
                        programma professionale unico, che ti aiuterà nella
                        scelta e gestione della tua attività professionale.
                    </p>
                </>
            ),
            img: '3',
            ...
            info: (
                <>
                    <p className="text-split">
                        {' '}
                        Analisi della tua mappa archetipica in relazione a
                        quelle componenti che favoriscono la migliore crescita
                        finanziaria e il raggiungimento di un benessere
                        economico duraturo.
                    </p>
                    <p className="text-split">
                        È possibile lavorare sia con una richiesta specifica che
                    ...
                    <p className="text-split">
                        Durante la consulenza riceverai un calcolo del tuo
                        programma finanziario unico, che diventerà istruzioni
                        affidabili per aumentare i tuoi guadagni.
                    </p>
                </>
            ),
            img: '3',
